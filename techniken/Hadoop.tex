...
Das \emph{MapReduce}-Framework bietet die Möglichkeit, Anwendungen mit einem großen Ressourcenbedarf, welche große Datenmengen verarbeiten, auf einem gesamten Cluster ausführen zu können. Dazu werden bei einem MapReduce-Job die Eingabedaten aufgeteilt, anschließend von den sog. \emph{Map Tasks} verarbeitet und deren Ausgabe von den sog. \emph{Reduce Tasks} geordnet. Meist wird für die Ein- und Ausgabe der Daten das HDFS genutzt, für die Ausführung der einzelnen Tasks wird YARN genutzt.
