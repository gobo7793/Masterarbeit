...
Anders sieht das jedoch in den sechs \glspl{Test} 7.1, 8 und 23 bis 26 aus.
...
Eine Analyse ergab, dass die Diagnostic"=Daten der \glspl{Anwendung} aufgrund eines falsch gesetzten Attributs in der \texttt{ApplicationResult}"=Klasse des Parsers nicht im Testsystem gespeichert werden konnten. \todo{Reflexion: Hätte bei vorabtests erkannt werden müssen!}
