...
Die meisten gefailten Apps sind hierbei mit 9 bzw. 8 bei den Tests 31 und 32 zu finden.
...
\todo{irgendwie noch die anzahl an failapp constraints einbauen}

% Warum sind Apps gefailt?
Anhand der Datenbasis lassen sich vier Gründe für das nicht erfolgreiche Abschließen der Anwendungen ausmachen:
...
\begin{itemize}
    ...
    \item Während der Ausführung einer \ac{MR}"=Anwendung wird ein Fehler im Map"=Task festgestellt \todo{weil benötigte Dateien nicht im cluster vorhanden sind, weil Nodes damit zwischenzeitlich beendet wurden}
