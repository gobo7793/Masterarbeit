...
Auch die Anforderung, dass die in \todo{impl komponentenfehler} implementierten Komponentenfehler im realen Cluster injiziert und repariert werden, konnte aufgrund des in \autoref{subsec:noReconf1922} erläuterten Falls nicht immer erfüllt werden.
