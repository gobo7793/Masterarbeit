...
Die meisten dieser Anforderungen wurden mithilfe der in \todo{Constraints} definierten Constraints implementiert, wodurch die Anforderungen bei jedem \gls{Testfall} automatisch validiert werden konnten.
...
Auch die Anforderung, dass die in \todo{impl komponentenfehler} implementierten Komponentenfehler im realen Cluster injiziert und repariert werden, konnte aufgrund des in \cref{subsec:noReconf1922} erläuterten Falls nicht immer erfüllt werden.
