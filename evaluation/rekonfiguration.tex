...
So wurde auch ein externer, nicht direkt durch die Anforderungen in \autoref{sec:predictions} abgedeckter Fehler erkannt, jedoch auf Kosten der Anforderung, dass im Modell implementierte Komponentenfehler im realen Cluster repariert werden.
