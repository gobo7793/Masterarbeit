...
Diese mittlere Auslastung reichte jedoch aus, um den Node im ausgeführten 3. Testfall gemäß \cref{subsubsec:yarnComponentFaults} wieder zu aktivieren, während die anderen noch aktiven Nodes spätestens in diesem Testfall aufgrund der hohen Last einen Komponentenfehler injiziert bekamen.
