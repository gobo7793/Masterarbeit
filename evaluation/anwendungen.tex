...
In diesen Fällen wurde als Resultat zudem das Constraint der Anforderung aus \autoref{sec:testRequirements}, wonach mehrere Benchmark"=Anwendungen gleichzeitig gestartet und ausgeführt werden können, aufgrund der Implementation aus \todo{Constraint-Impl} durch das Oracle als ungültig validiert.
