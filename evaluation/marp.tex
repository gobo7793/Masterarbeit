...
Während bei allen Testkonfigurationen, bei denen Mutationen aktiv waren, der \ac{MARP}"=Wert unverändert blieb (vgl. \autoref{sec:killingMutants}), wurde er bei 17 von 21 Ausführungen der 16 Konfigurationen ohne Mutationen verändert:
