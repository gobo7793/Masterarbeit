...
Weitere Informationen zur \gls{REST}"=API sowie hier nicht gezeigte Pfade für die \gls{YARN}"=Komponenten sind in der Dokumentation \cite{HadoopYarnTlServer271,HadoopRmApi271,HadoopNmApi271} zu finden.
