...
caption={[Starten einer \gls{Anwendung} in Hadoop"=Benchmark]
    Starten einer \gls{Anwendung} in Hadoop"=Benchmark.
    Hier mit dem Mapreduce Example \acrlong{pi} und dem Abbruch der \gls{Anwendung} durch den in \cref{lst:hadoopAppKill} gezeigten Befehl.
...
caption={[Vorzeitiges Beenden einer Anwendung]
    ...
    Hier wird die in \cref{lst:hadoopAppStart} gestartete \gls{Anwendung} vorzeitig beendet.}]
