...
\begin{lstlisting}[label=lst:hadoopAppListCmd,style=cs,
...
\begin{lstlisting}[label=lst:hadoopAppDetailsCmd,style=cs,
...
\begin{lstlisting}[label=lst:hadoopAppStart,style=cs,
caption={[Starten einer Anwendung in Hadoop"=Benchmark]
    Starten einer Anwendung in Hadoop"=Benchmark.
    Hier mit dem Mapreduce Example \acl{pi} und dem Abbruch der Anwendung durch den in \cref{lst:hadoopAppKill} gezeigten Befehl.
...
\begin{lstlisting}[label=lst:hadoopAppKill,style=cs,
