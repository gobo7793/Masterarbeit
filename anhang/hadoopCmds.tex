\chapter{\acs{CLI}"=Befehle von Hadoop}
...
caption={[\acs{CLI}"=Ausgabe der Anwendungsliste]
    ...
    Anwendungen können mithilfe der Optionen \texttt{-{}-appTypes} und \texttt{-{}-appStates} gefiltert werden.}]
...
caption={[Starten einer Anwendung in Hadoop"=Benchmark]
    ...
    Die \texttt{applicationId} ist hier in Zeile 13 enthalten.}]
