...
In den Spalten \emph{Ausgeführte Testfälle} und \emph{Dauer} ist angegeben, wie viele \glspl{Testfall} bzw. Simulations"=Schritte vollständig und erfolgreich ausgeführt wurden, bzw. wie viel Zeit die jeweiligen Simulationen in Minuten und Sekunden benötigten.
Wenn nicht alle möglichen \glspl{Testfall} ausgeführt wurden, war im darauf folgenden \gls{Testfall} eine Rekonfiguration des Clusters nicht mehr möglich und die Simulation wurde abgebrochen (vgl. \cref{subsec:oracleImpl}).
