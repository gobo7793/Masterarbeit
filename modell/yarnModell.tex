...
Bei der Nutzung der \gls{CLI} zur Ermittlung der Daten eignet sich die Selbstermittlung der Daten besser, während bei der Nutzung der REST"=API die Ermittlung der Daten durch die übergeordnete Komponente geeigneter ist; die Gründe hierfür sind in \cref{sec:sshDriver} erläutert.
