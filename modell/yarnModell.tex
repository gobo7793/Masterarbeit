...
Die Start"= und Stop"=Methoden sowie die Eigenschaften \texttt{IsActive} und \texttt{IsConnected} in \texttt{YarnNode} dienen zur Identifikation und Injektion bzw. Reparatur der Komponentenfehlern (vgl. \cref{subsec:yarnComponentFaults}).
...
Zudem wird ein Komponentenfehler eher deatkviert, wenn der Node eine geringe Auslastung aufweist, während die Aktivierung bevorzugt bei einer hohen Auslastung durchgeführt wird.
