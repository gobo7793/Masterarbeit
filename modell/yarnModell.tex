...
caption={[Injizierung eines Komponentenfehlers]
    ...
    Sollte der Node nicht beendet werden, wird die Injizierung einmalig erneut versucht. \texttt{CmdConnector.Faulting} ist die für Komponentenfehler verwendete eigentliche SSH"=Verbindung.},
float,style=cs]
