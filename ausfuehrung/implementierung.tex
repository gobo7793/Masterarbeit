...
Hierbei wird geprüft, ob die in \todo{verweis zu Anforderungen} in Form der Constraints für die jeweiligen Komponenten noch erfüllt werden können.
...
Ausgegeben und im Log gespeichert werden dabei folgende Eigenschaften der jeweiligen Komponenten bzw. Klassen: \todo{Auflistung in der Form zum Evaluationsplan, hier eher das Format}
