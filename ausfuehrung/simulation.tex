...
Eine Besonderheit bildet das Feld \texttt{\_PrecreatedInputs}.
...
Hierbei wird zunächst überprüft, ob die in \autoref{sec:clusterRequirements} beschrieben funktionalen Anforderungen an Hadoop in Form der in \todo{constraint implementierung} implementierten Constraints für die jeweiligen Komponenten noch erfüllt werden können.
