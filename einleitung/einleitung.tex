...
Konkret soll hier mit Apache Hadoop\footnote{\url{https://hadoop.apache.org/}} ein reales, in der Forschung und Praxis eingesetztes \cite{PoweredByHadoop}, verteiltes Load"=Balancing"=System als zu testendes System (\acrlong{SuT}, kurz \acrshort{SuT}\glsunset{SuT}) dienen.
