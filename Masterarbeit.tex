\documentclass[12pt,a4paper,ngerman,bibliography=totoc]{scrreprt}
...
\usepackage{varioref}
\usepackage[bookmarksnumbered,pdfpagemode=UseNone]{hyperref}
\usepackage{bookmark}
...
\begin{document}
    ...
    \begin{singlespace}
        ...
        \textbf{Abkürzungen der Benchmarks (vgl. \cref{subsec:appSelection}):}
        \printnoidxglossary[sort=def,type=apps]
    \end{singlespace}
