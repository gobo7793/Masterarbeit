...
Neben den Anforderungen an Hadoop und das gesamte Testsystem muss auch der grundlegende Versuchsaufbau und das \gls{SuT} definiert werden.
...
In diesem Cluster sollen anhand des Modells unterschiedliche Komponentenfehler injiziert und repariert, sowie unterschiedliche Benchmarks gestartet werden.
...
Das \gls{SuT} selbst stellt das reale Hadoop"=Cluster dar, das mithilfe Plattform Hadoop"=Benchmark umgesetzt werden soll.
