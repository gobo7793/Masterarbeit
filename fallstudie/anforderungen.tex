...
Unterschieden wird hierbei zwischen funktionalen Anforderungen an das verwendete Hadoop"=Cluster und Anforderungen an das Testsystem.
Während die funktionalen Anforderungen ausschließlich vom Cluster erfüllt werden müssen, müssen die Test"=Anforderungen vom gesamten Testsystem erfüllt werden.
...
Obwohl in dieser Masterarbeit der Fokus auf Testautomatisierung und Validieren eines Testsystems liegt, müssen auch die funktionalen Anforderungen an das zu testende Hadoop"=Cluster berücksichtigt werden.
...
Dies betrifft konkret folgende, bereits in \cite{Eberhardinger2018} definierte, Anforderungen:
