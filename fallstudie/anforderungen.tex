...
Dies betrifft konkret folgende, bereits in \cite{Eberhardinger2018} definierte, Anforderungen an das \gls{SuT}:
...
Wird diese Anforderung verletzt soll der ausgeführte \gls{Test} abgebrochen werden, während bei den anderen, auch den funktionalen, Anforderungen dies nur durch das Oracle vermerkt werden soll, die Ausführung aber nicht weiter durch das Oracle beeinträchtigt werden soll.
