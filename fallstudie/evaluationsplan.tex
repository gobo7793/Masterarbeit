...
Die Details zur Implementierung und dem Ausgabeformat während der Ausführung der Simulation sind in \cref{subsubsec:simulationStepOutput} erläutert, die zur Ausgabe der generellen Testfalldaten in \cref{sec:implTestcases}. Ein Beispiel einer möglichen Ausgabe für einen Testfall findet sich in \cref{app:outputFormat}.
