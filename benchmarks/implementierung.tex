...
\begin{description}
    ...
    \item [Transition zwischen Anwendungen] Trifft keiner der anderen Fälle zu, wird basierend auf dem Transitionssystem die nachfolgende Anwendung ausgewählt.
\end{description}
