...
Der \textbf{statische Teil} des Controllers definiert die möglichen Anwendungen sowie das im Abschnitt zuvor definierte und in \autoref{tab:transitionsystem} dargestellte Transitionssystem.
...
Dafür wird der in \autoref{app:hadoopCmds} dargestellte Befehl von Hadoop zum Abbruch von Anwendungen ausgeführt, wodurch die derzeit ausgeführte Anwendung beendet wird, sollte sie noch nicht abgeschlossen sein.
...
Die gesamte Ausgabe einer zu startenden Anwendung ist ebenfalls in \autoref{app:hadoopCmds} zu finden.
